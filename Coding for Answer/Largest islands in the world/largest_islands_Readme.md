...
Using structured geographical data, the analysis ranks the world’s largest islands and examines how definitions and classifications (island vs continent) affect global rankings. This project demonstrates foundational data analysis skills applied to real-world reference data.
...
- Present clear, ordered results using data analysis techniques
...
- Classification notes (island vs continent)

The data enables comparison while highlighting how **definition choices** can influence analytical outcomes.
