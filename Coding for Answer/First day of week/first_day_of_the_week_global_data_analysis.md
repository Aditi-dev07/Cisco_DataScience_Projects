...
Using real-world datasets, the analysis investigates how different countries and regions define the start of the week, both by **number of territories** and **population impact**. The project demonstrates data cleaning, merging multiple datasets, aggregation, and analytical reasoning using Python.

This notebook was created as part of a data analysis exercise and is designed to highlight my ability to work with structured datasets, derive insights, and communicate findings clearly — skills directly relevant to data analyst and data science roles.
...
- Are there regions that are culturally **divided** between Sunday and Monday starts?
...
- Working with real-world, imperfect datasets
...
These datasets were combined to analyze both **territorial distribution** and **population-weighted impact**.
...
- Other regions show more variation, highlighting cultural and regional differences in calendar norms.
...
2. Upload the following files when prompted:
   ...
   - `population.csv`
   - `four-regions.csv`
3. Run the cells top-to-bottom to reproduce the analysis
...
- Use Python and pandas effectively for real-world analysis
- Communicate findings in a clear, structured way

It reflects how I approach data problems in professional environments — with curiosity, rigor, and clarity.
